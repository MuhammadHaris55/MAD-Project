...
{
  final String value;
  Proceedpayment({Key key,this.value}): super (key: key);
  @override
  State<StatefulWidget> createState()=> new _GotoProceedpayment();
}

//we use underscore before a class name to make it private

class _GotoProceedpayment extends State<Proceedpayment> {
            ...
            child: new Form(
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  FlatButton.icon(
                    label: Text('Proceed Payment', style: new TextStyle(
                    ...
                    onPressed:(){
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> BuySheet()));
                    },
                  ),
